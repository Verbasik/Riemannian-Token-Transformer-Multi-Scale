...
- Ключевые параметры:
  - `data`: `data_dir`, `subject_ids` (дефолт `['sub-03']`), `task`, `normalize='zscore_hybrid'`, `exclude_channels=[124]`
...
- Исторически лучший сетап (A6 на базе A2/A3, sub-04 Fold 1) давал f1_macro≈0.2915; текущий дефолт для запуска изменён на `subject_ids=['sub-03']`.
