...
# ============================================================================
# АКТУАЛЬНЫЙ СТАТУС (2026-03-02)
# ============================================================================
#
# ЧТО УЖЕ СДЕЛАНО:
# 1) Subject-aware режимы реализованы в коде:
#    - stratified_group
#    - loso
# 2) Исправлен вызов train.main(cfg) из run_full_evaluation.py
# 3) Исправлен путь к данным (/mnt/data/derivatives/preprocessed_pkl)
# 4) Добавлен fallback для single-subject:
#    stratified_group -> stratified
# 5) Выполнен full evaluation: 25/25 успешных запусков
#
# ЧТО ОСТАЕТСЯ:
# 1) Обновить review.txt (разделы 10.7, 11.1, 11.7, 13) под новые метрики.
# 2) Добавить калибровку: Temperature Scaling + ECE/NLL/Brier.
# 3) Обновить AMP API:
#    torch.cuda.amp.* -> torch.amp.*
# 4) Зафиксировать отдельный cross-subject отчёт (LOSO/SGKF multi-subject).
# ============================================================================
